...
set opl_lut_depth_bits    [expr int(log(${opl_lut_size})/log(2))]
#####################################
# Project Settings
#####################################
...
set_property CONFIG.C_LUT_DEPTH_BITS ${opl_lut_depth_bits} [get_ips output_port_lookup_ip]
set_property CONFIG.C_M_AXIS_DATA_WIDTH ${datapath_width_bit} [get_ips output_port_lookup_ip]
set_property CONFIG.C_S_AXIS_DATA_WIDTH ${datapath_width_bit} [get_ips output_port_lookup_ip]
