...
# Read the counters
if isHW():
	rres1=nftest_regread_expect(NFPLUS_OUTPUT_PORT_LOOKUP_0_PKT_DROPPED_WRONG_DST_MAC_CNTR(), pkts_num*2)
	mres=[rres1]
else:
	nftest_regread_expect(NFPLUS_OUTPUT_PORT_LOOKUP_0_PKT_DROPPED_WRONG_DST_MAC_CNTR(), pkts_num)
	mres=[]
