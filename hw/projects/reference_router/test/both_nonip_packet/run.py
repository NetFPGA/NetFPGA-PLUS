...
# Read the counters
if isHW():
	rres1=nftest_regread_expect(NFPLUS_OUTPUT_PORT_LOOKUP_0_PKT_SENT_TO_CPU_NON_IP_CNTR(), pkts_num*2)
	mres=[rres1]
else:
	simReg.regDelay(200)
	nftest_regread_expect(NFPLUS_OUTPUT_PORT_LOOKUP_0_PKT_SENT_TO_CPU_NON_IP_CNTR(), pkts_num)
	mres=[]
