...
if isHW():
	rres1=nftest_regread_expect(NFPLUS_OUTPUT_PORT_LOOKUP_0_PKT_DROPPED_CHECKSUM_CNTR(), pkts_num*2)
	mres=[rres1]
else:
	nftest_regread_expect(NFPLUS_OUTPUT_PORT_LOOKUP_0_PKT_DROPPED_CHECKSUM_CNTR(), pkts_num)
	mres=[]
