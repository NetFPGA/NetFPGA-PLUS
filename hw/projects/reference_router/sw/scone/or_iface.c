...
void read_hw_iface_mac(router_state *rs, unsigned int port, unsigned int *mac_hi, unsigned int *mac_lo) {
	...
	switch(port) {
		...
		case 0:
			readReg(rs->netfpga_regs, NFPLUS_OUTPUT_PORT_LOOKUP_0_MAC_0_HI, mac_hi);
			readReg(rs->netfpga_regs, NFPLUS_OUTPUT_PORT_LOOKUP_0_MAC_0_LOW, mac_lo);
			break;

		case 1:
			readReg(rs->netfpga_regs, NFPLUS_OUTPUT_PORT_LOOKUP_0_MAC_1_HI, mac_hi);
			readReg(rs->netfpga_regs, NFPLUS_OUTPUT_PORT_LOOKUP_0_MAC_1_LOW, mac_lo);
			break;
...
void write_hw_iface_mac(router_state *rs, unsigned int port, unsigned int mac_hi, unsigned int mac_lo) {
	...
	switch(port) {
		...
		case 0:
			writeReg(rs->netfpga_regs, NFPLUS_OUTPUT_PORT_LOOKUP_0_MAC_0_HI, mac_hi);
			writeReg(rs->netfpga_regs, NFPLUS_OUTPUT_PORT_LOOKUP_0_MAC_0_LOW, mac_lo);
			break;

		case 1:
			writeReg(rs->netfpga_regs, NFPLUS_OUTPUT_PORT_LOOKUP_0_MAC_1_HI, mac_hi);
			writeReg(rs->netfpga_regs, NFPLUS_OUTPUT_PORT_LOOKUP_0_MAC_1_LOW, mac_lo);
			break;

		case 2:
			writeReg(rs->netfpga_regs, NFPLUS_OUTPUT_PORT_LOOKUP_0_MAC_2_HI, mac_hi);
			writeReg(rs->netfpga_regs, NFPLUS_OUTPUT_PORT_LOOKUP_0_MAC_2_LOW, mac_lo);
			break;
		case 3:
			writeReg(rs->netfpga_regs, NFPLUS_OUTPUT_PORT_LOOKUP_0_MAC_3_HI, mac_hi);
			writeReg(rs->netfpga_regs, NFPLUS_OUTPUT_PORT_LOOKUP_0_MAC_3_LOW, mac_lo);
			break;
		default:
