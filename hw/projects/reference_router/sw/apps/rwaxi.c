...
#include "../common/nf_sume.h"

#define	NFPLUS_DEFAULT_TEST_ADDR		0x00020000
...
main(int argc, char *argv[])
{
	...
	flags = 0x00;
	addr = NFPLUS_DEFAULT_TEST_ADDR;
	ifnam = NFPLUS_IFNAM_DEFAULT;
	value = 0;
	...
	rc = ioctl(fd, NFPLUS_IOCTL_CMD_READ_REG, &ifr);
	if (rc == -1)
		err(1, "ioctl");
